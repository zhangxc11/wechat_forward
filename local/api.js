...
var a = function() {
    ...
    c.polluteGlobalNamespace = function() {
        ...
        b.indexOf("//") === 0 && (b = d.protocol + b), b.indexOf("/") === 0 && (b = d.protocol + "//" + d.host + b), b = b.replace(/[/]+$/, "");
        var e = b.split("/");
        if (e[0] === "http:" && /:80$/.test(e[2]) || e[0] === "https:" && /:443$/.test(e[2]))
            e[2] = e[2].replace(/:(80|443)$/, "");
        return b = e.join("/"), b
    ...
    y.prototype = new d, y.version = "--minify", y.CONNECTING = 0, y.OPEN = 1, y.CLOSING = 2, y.CLOSED = 3, y.prototype._debug = function() {
        ...
        var a = this;
        a.readyState === y.CONNECTING && (a._transport_tref && (clearTimeout(a._transport_tref), a._transport_tref = null), a.readyState = y.OPEN, a.dispatchEvent(new e("open")))
...
sae = {
    Channel: function(b, c) {
        return new a("http" + b.slice(2), null, c)
    }
}, sae.Channel.bootstrap_iframe = a.bootstrap_iframe, "_sockjs_onload"in window && setTimeout(_sockjs_onload, 1), typeof define == "function" && define.amd && define("sae", [], function() {
    return sae
})
